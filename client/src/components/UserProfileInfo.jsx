        ...
        <div className='flex flex-col md:flex-row items-start gap-6'>
            ...
            <div className='w-full pt-16 md:pt-0 md:pl-36'>
                <div className='flex flex-col md:flex-row items-start justify-between'>
                    ...
                    {/* if user is not on others profile that means he i opening his profile so we will give edit button   */}
                    {!profileId && 
                    
                        <button onClick={()=> setShowEdit(true)} className='flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-lg   hover:bg-gray-50 font-medium transition-colors mt-4 md:mt-0 cursor-pointer'> 
                ...
                <div className='flex items-center gap-6 mt-6 border-t border-gray-200'>
                        ...
                        <div>
                            <span className='sm:text-xl font-bold text-gray-900'>{post.length}</span>
