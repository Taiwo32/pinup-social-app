...
const StoryModel = ({setShowModel, fetchStories}) => {
    ...
    const bgColors = ["#4f46e5", "#db2777", "#7c3aed", "#e111d48", "#ca8a04", "#0d9488", "#0369a1", "#d97706", "#b91c1c", "#0f172a"]
  ...
  return (
    <div className='fixed inset-0 z-10 min-h-screen bg-black/80 backdrop-blur text-white flex items-center justify-center p-4  '>
        <div className=' ml-60 w-full max-w-md'>
            <div className='text-center mb-4 flex items-center justify-baseline'>
            ...
            <button onClick={()=> toast.promise(handleCreateStory(), {loading:'Saving....',  })} className='flex items-center justify-center gap-2 text-white py-3 mt-4 w-full rounded bg-linear-to-r from-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800 active:scale-95 transition cursor-pointer'>
