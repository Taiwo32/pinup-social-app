    ...
    <div className='min-h-screen flex flex-col md:flex-row'>
        ...
        <div className='flex-1 flex flex-col justify-between items-start p-6 md:p-10 lg:pl-40 '>
            ...
            <div>
                ...
                <h1 className='text-3xl md:text-6xl md:pb-2 font-bold bg-linear-to-r  from-indigo-500 to-indigo-800 bg-clip-text text-transparent'>More than just friends truly connect</h1>
